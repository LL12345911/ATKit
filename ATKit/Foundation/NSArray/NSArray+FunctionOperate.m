...
-(NSArray *)at_ComplementaryArrayWithArr:(NSArray *)arr usingEqualBlock:(BOOL (^)(id,id))block{
...
-(NSArray *)at_ComplementaryArrayFromArr:(NSArray *)arr usingEqualBlock:(BOOL (^)(id,id))block{
    return [arr at_ComplementaryArrayWithArr:self usingEqualBlock:block];
}

-(NSArray *)at_SplitArrayByCapacity:(NSUInteger)capacity{
    if (capacity == 0) {
        return nil;
    }
...
-(NSArray *)unitformWithCount:(NSInteger)count{
