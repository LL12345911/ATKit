 ...
 */
-(NSArray * __nullable)at_ComplementaryArrayWithArr:(NSArray * __nullable)arr usingEqualBlock:(BOOL(^__nullable)(id __nullable obj1,id __nullable obj2))block;

///获取arr中相对于自身的补集
-(NSArray * __nullable)at_ComplementaryArrayFromArr:(NSArray * __nullable)arr usingEqualBlock:(BOOL(^__nullable)(id __nullable obj1,id __nullable obj2))block;

///将数组按数量分为多个数组
-(NSArray * __nullable)at_SplitArrayByCapacity:(NSUInteger)capacity;
/** 数组按指定数量等分*/
-(NSArray * __nullable)unitformWithCount:(NSInteger)count;
